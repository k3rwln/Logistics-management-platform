...
EMAIL_SUBJECT_PREFIX = '[Oscar lmp] '
...
INSTALLED_APPS = [
    ...
    # Django apps that the lmp depends on
    'django.contrib.sitemaps',

    # 3rd-party apps that the lmp depends on
    'django_extensions',
    'debug_toolbar',
...
THUMBNAIL_KEY_PREFIX = 'oscar-lmp'
